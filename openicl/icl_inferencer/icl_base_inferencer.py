...
#from openicl.utils.azure_service import *
# from openicl.icl_evaluator import *
from transformers import AutoTokenizer, AutoModelForCausalLM, AutoModelForSeq2SeqLM, PretrainedConfig, GPT2Tokenizer, AutoConfig
...
class BaseInferencer:
    ...
    def __init__(self,
        ...
        if self.model is not None:
            if ('quantize' not in kwargs.keys()) or (kwargs['quantize'] is False):
